...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (event) {
    ...
    var camposRequeridos = ['hora_inicio', 'hora_fin', 'fecha_inicio', 'fecha_fin', 'permiso', 'adicional', 'observaciones', 'firma_jefe'];
...
function _mostrarAlerta() {
  _mostrarAlerta = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
