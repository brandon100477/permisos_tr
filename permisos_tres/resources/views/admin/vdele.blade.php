...
<nav class="navbar" style="background-color: rgba(115,188,220,255);">
        ...
        <div class="container">
            ...
            <div class="buttons">
                ...
                <form action="{{ route('ruta_enablepack')}}" method="post" id="bin">
                    @csrf
                    <input type="button"  value="Seleccionar todo" class="btn btn-warning btn-sm botton" id="seleccionarTodo">
                    
                    <button type="submit" class="btn btn-warning btn-sm botton eliminar" id="boton_eliminar" value="botton2" name="submit_action">Habiliar</button><!-- Botón para exportar el excel -->
                            ...
                            <table>
                                ...
                                @foreach ($personas as $persona)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ route('ruta_enable', ['id' => $persona->id])}}" name="ide" id="one-delete" class="eliminar-link" ><i class="fa fa-unlock" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
